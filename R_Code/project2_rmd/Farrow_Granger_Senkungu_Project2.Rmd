...
install.if.nec( c("tidyverse", "Amelia", "corrplot", "pscl", "ROCR", "MASS" ) )
#  Try/install necessary packages
...
x <- table(wdbc.test$Class,glm.probs > 0.1)
x

# Accuracy when using Max Accuracy Cutoff is 96%
(x[1] + x[4])/(x[1] + x[2] + x[3] + x[4])

# TP and FP Rates When Using Max Accuracy Cutoff
# TP Rate: 98%
x[4]/(x[4] + x[2])
# FP Rate: 5%
x[3]/(x[3] + x[1])
